...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.org.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.org.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        %>
        <jsp:useBean id="com1org1Person_1id" scope="session" class="com.org.Person" />
        <%
        com1org1Person_1id.setAge(age_2idTemp);
        com1org1Person_1id.setName(name_3idTemp);
        com1org1Person_1id.setId(id_4idTemp);
        boolean addPerson15mtemp = samplePersonServiceImplProxyid.addPerson(com1org1Person_1id);
...
case 31:
        gotMethod = true;
        com.org.Person[] getAllPersons31mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
case 34:
        ...
        com.org.Person getPerson34mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
